...
(function(c,h){c.fn.jPlayer=function(a){var b=typeof a==="string",d=Array.prototype.slice.call(arguments,1),f=this;a=!b&&d.length?c.extend.apply(null,[true,a].concat(d)):a;if(b&&a.charAt(0)==="_")return f;b?this.each(function(){var e=c.data(this,"jPlayer"),g=e&&c.isFunction(e[a])?e[a].apply(e,d):e;if(g!==e&&g!==h){f=g;return false}}):this.each(function(){var e=c.data(this,"jPlayer");if(e){e.option(a||{})._init();e.option(a||{})}else c.data(this,"jPlayer",new c.jPlayer(a,this))});return f};c.jPlayer=
        ...
        <style>
html,body,div,span,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,abbr,address,cite,code,del,dfn,em,img,ins,kbd,q,samp,small,strong,sub,sup,var,b,i,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,figcaption,figure,footer,header,hgroup,menu,nav,section,summary,time,mark,audio,video{border:0;outline:0;font-size:100%;vertical-align:baseline;background:transparent;margin:0;padding:0}body{line-height:1;font-family:'Helvetica Neue', Arial, sans-serif;background:#222;font-size:13pt}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}ul{list-style:none}blockquote,q{quotes:none}blockquote:before,blockquote:after,q:before,q:after{content:none}a{font-size:100%;vertical-align:baseline;background:transparent;margin:0;padding:0}ins{background-color:#ff9;color:#000;text-decoration:none}mark{background-color:#ff9;color:#000;font-style:italic;font-weight:700}del{text-decoration:line-through}abbr[title],dfn[title]{border-bottom:1px dotted;cursor:help}table{border-collapse:collapse;border-spacing:0}hr{display:block;height:1px;border:0;border-top:1px solid #ccc;margin:1em 0;padding:0}input,select{vertical-align:middle}.clear{clear:both}#page{width:500px;margin:40px auto}.jp-audio{margin-bottom:20px;font-size:12pt}.jp-controls a{color:#777;text-decoration:none}.jp-controls li{float:left;margin-right:20px}.jp-current-time,.jp-duration{display:inline;color:#999;font-size:10pt}#folder-list table{text-align:left;width:100%}#folder-list table .number{width:5px}#folder-list table th{border:1px solid #000;background:#111;color:#888;font-weight:700;padding:7px 10px}#folder-list table td{border-bottom:1px solid #333;color:#666;font-size:10pt;padding:7px 10px}#folder-list table tr.playing{background:#313131}#folder-list table tr:hover{background:#333}#folder-list table td a{color:#666;text-decoration:none}@media (min-device-width:1024px) and (max-width:509px),(max-device-width:480px) and (orientation:portrait) {#page{width:300px;margin:40px auto}.album{display:none}}
        </style>
    </head>
